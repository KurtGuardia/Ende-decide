...
export type DemoState={decisionRegistered:boolean; progress:number; closed:boolean; escalated:boolean; note:string; requiredDocuments:string[]; evidence:Evidence[]; events:Event[]};
